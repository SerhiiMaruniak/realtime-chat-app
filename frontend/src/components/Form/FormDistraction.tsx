...
const FormDistraction = ({ header, description }: FormDistractionProps) => {
  return (
    <div className="form-distraction flex-col justify-center items-center gap-5 md:gap-7">
      <div className="grid grid-cols-3 grid-rows-3 gap-4 md:gap-6">
        <div className="w-18 h-18 md:w-22 md:h-22 bg-main rounded-lg even:bg-spec-1 even:animate-pulse"></div>
        <div className="w-18 h-18 md:w-22 md:h-22 bg-main rounded-lg even:bg-spec-1 even:animate-pulse"></div>
        <div className="w-18 h-18 md:w-22 md:h-22 bg-main rounded-lg even:bg-spec-1 even:animate-pulse"></div>
        <div className="w-18 h-18 md:w-22 md:h-22 bg-main rounded-lg even:bg-spec-1 even:animate-pulse"></div>
        <div className="w-18 h-18 md:w-22 md:h-22 bg-main rounded-lg even:bg-spec-1 even:animate-pulse"></div>
